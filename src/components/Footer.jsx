        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="text-center">
            <p className="text-lg text-gray-400">
              © {currentYear} Renato Rocha. Todos os direitos reservados.
            </p>
          </div>
          ...
          <button
            onClick={scrollToTop}
            className="text-gray-400 hover:text-emerald-500 transition-colors duration-300 flex items-center space-x-2 text-lg"
          >
